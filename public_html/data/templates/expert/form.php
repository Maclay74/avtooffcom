    ...
    <form id = "agentForm" method="POST" action="?event=agent&action=form" class="form-horizontal">
        <fieldset>
            ...
            <input id="id" name ="id" value="<?php echo $data[0]['id']; ?>" type="input" style="display:none" >
                ...
                <label class="control-label" for="second_name">Фамилия</label>
                <div class="controls">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input validatod="text" id="first_name" value='<?php echo $data[0]['first_name']; ?>' name="first_name" type="text" placeholder="" class="input-large" required="">
                    <i id="okay" style="display:none" class="icon-ok"></i>
                    <i id="remove" style="display:none" class="icon-remove"></i>
                </div>
            ...
            <!-- Text input-->
            <div class="control-group">
                <label class="control-label" for="third_name">Отчество</label>
                <div class="controls">
                    <input  validatod="text" id="third_name" value='<?php echo $data[0]['third_name']; ?>' name="third_name" type="text" placeholder="" class="input-large" required="">
                    <i id="okay" style="display:none" class="icon-ok"></i>
                    <i id="remove" style="display:none" class="icon-remove"></i>
                </div>
